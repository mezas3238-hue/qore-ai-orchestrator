#!/usr/bin/env python3
"""Run Codex as QORE Principal Engineer in the initial plan-only rollout."""
...
def main() -> int:
    ...
    body = {
        ...
        "input": (
            ...
            "Use the repository state evidence to identify likely files/tests, but do not claim to have modified code.\n\n"
        ...
        "store": False,
        "metadata": {
            "qore_role": "principal_engineer_plan_only",
            "qore_main_sha": str(snapshot.get("main_sha", "")),
        },
    }
